...
class P剑指OfferII090PzWKhm{
    public static void main(String[] args) {
        Solution solution = new P剑指OfferII090PzWKhm().new Solution();
        // TO TEST
        solution.rob(new int[]{1,3,1,3,100});
    }
...
class Solution {
    public int rob(int[] nums) {
        ...
        return Math.max(dpMothed(nums,0,len-2), dpMothed(nums,1,len-1));
    }
    public int dpMothed(int[] nums, int start, int end){
