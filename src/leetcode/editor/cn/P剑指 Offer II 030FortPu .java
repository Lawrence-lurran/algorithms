...
class P剑指OfferII030FortPu{
    public static void main(String[] args) {
        //Solution solution = newP剑指OfferII030FortPu().new Solution();
        // TO TEST
...
class RandomizedSet {
    ...
    public boolean remove(int val) {
        ...
        int res=hashmap.get(val);
        hashmap.put(data.get(data.size()-1),res);
        hashmap.remove(val);
        data.set(res,data.get(data.size()-1));
